...
FAT_LICENSE = 'META-INF/LICENSE_figaro-6.0.0-modern.20-SNAPSHOT'
REQUIRED = ('com/cra/figaro/language/Universe.class',
            ...
            'com/cra/figaro/algorithm/sampling/InferenceHealth$.class',
            'com/cra/figaro/algorithm/sampling/VectorImportance$.class',
            'com/cra/figaro/algorithm/sampling/GaussianMixtureProposal$.class',
            'com/cra/figaro/algorithm/sampling/GraphProposalImportance$.class',
            'com/cra/figaro/algorithm/sampling/MonteCarloInformation$.class',
            'com/cra/figaro/algorithm/sampling/BoundedIidPrecision$.class',
            'com/cra/figaro/algorithm/sampling/EmpiricalBernsteinPrecision$.class',
            ...
            'com/cra/figaro/library/atomic/LegacyInformation$.class',
            'com/cra/figaro/library/atomic/continuous/LKJDistribution.class',
            'com/cra/figaro/library/atomic/continuous/InverseWishartDistribution.class',
...
def main():
    ...
    for kind, suffix in (('thin',''),('fat','-fat'),('sources','-sources'),('javadoc','-javadoc')):
        path = args.directory / f'figaro_3-6.0.0-modern.20-SNAPSHOT{suffix}.jar'
