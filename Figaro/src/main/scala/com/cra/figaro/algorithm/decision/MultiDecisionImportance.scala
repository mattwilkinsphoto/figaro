 ...
 */
class OneTimeMultiDecisionImportance(universe: Universe, myNumSamples: Int, utilityNodes: List[Element[?]], targets: Decision[?, ?]*)
...
object MultiDecisionImportance {
   ...
   */
  def apply(numSamples: Int, utilityNodes: List[Element[?]], targets: Decision[?, ?]*)(implicit universe: Universe) = {
    new OneTimeMultiDecisionImportance(universe, numSamples, utilityNodes, targets*)
  }
