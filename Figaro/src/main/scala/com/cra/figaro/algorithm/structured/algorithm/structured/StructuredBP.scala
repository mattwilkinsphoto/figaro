...
class StructuredBP(universe: Universe, iterations: Int, targets: Element[?]*) extends StructuredProbQueryAlgorithm(universe, targets*)
...
object StructuredBP {
  ...
  def apply(iterations: Int, targets: Element[?]*) = {
    ...
    new StructuredBP(targets(0).universe, iterations, targets*)
  }
