...
```scala
scalaVersion := "3.9.0"
libraryDependencies += "io.github.mattwilkinsphoto" %% "figaro" % "6.0.0-modern.19-SNAPSHOT"
```
...
- [Legacy distribution contracts](docs/LEGACY_DISTRIBUTION_CONTRACTS.md): stable log likelihoods, inverse-Gamma migration, count proposals and analytic KL/Bhattacharyya.
...
- [Joint-count, tail, matrix and spherical distributions](docs/DISTRIBUTION_BREADTH.md): five new representative kernels, graph adapters and appropriate information metrics.
...
- [Pilot-fitted mixture proposals](docs/MIXTURE_PROPOSALS.md): explicit multi-component
  fitting, refusal semantics and paired single-versus-mixture evidence.
