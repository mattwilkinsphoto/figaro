...
1. Get the Scala 3 branch:
   ...
   ```sh
   git clone --branch modernize/deprecation-retirement https://github.com/mattwilkinsphoto/figaro.git
   cd figaro
   ```
...
- [Deprecation retirement](docs/DEPRECATION_RETIREMENT.md): current API replacements, lazy-collection behavior, and the following parallel-performance investigation.
