...
Java consumers will use the corresponding binary artifact (for example, `figaro_2.12`) together with its declared Scala/runtime dependencies. The published POM is the dependency contract.
