...
| DIST-08 / P2 | Joint vector/simplex/count laws; MVN/Dirichlet native; full-rank multivariate t implemented for modern.14 | [Elliptical multivariate t](docs/MULTIVARIATE_STUDENT_T.md); multinomial count vectors remain wishlist | Negative multinomial, Dirichlet count mixtures, joint survival and continuous-categorical |
