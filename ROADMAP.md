...
| D4: reusable constructions (`DIST-10`) | Implemented on `modernize/distribution-constructions`; acceptance in progress | Affine/exp transformations, finite truncation, scalar mixtures, full-covariance Gaussian mixture models, hurdle/zero-inflated counts; Gaussian KL/Bhattacharyya and partition MI | [Guide](docs/DISTRIBUTION_CONSTRUCTIONS.md) and [actual acceptance status](docs/DISTRIBUTION_CONSTRUCTIONS_ACCEPTANCE.md); no generic mixed-measure law, EM fitter or mixture-divergence shortcut |
