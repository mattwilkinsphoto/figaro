...
| D2: linear-angular joint models (`DIST-02`) | Local implementation validated; public release review open | Fixed-kernel Gauss-von Mises on a real vector plus one angle, built on D1 | 13 new regressions; [user guide and boundaries](docs/GAUSS_VON_MISES.md); joint branch remains local pending release direction |
